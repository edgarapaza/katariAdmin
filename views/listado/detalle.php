				...
				<form action="<?php echo constant('URL')."listado/update/". $this->datos['idpersonal'];?>" method="post" enctype="multipart/form-data">
				  <div class="grid-container">
				    ...
				    <div class="grid-x grid-padding-x">
				      ...
				      <div class="small-12 medium-4 cell">
				        <label>Telefono
				          <input type="text" value="<?php echo $this->datos['telefono'];?>" name="telefono" id="telefono" required
				        </label>
				      </div>
				      <div class="small-12 medium-4 cell">
				        <label>DNI
				    ...
				    <div class="grid-x grid-padding-x">
				      <div class="small-12 medium-4 cell">
				        <label>Fecha de Nacimiento
				          <input type="date" name="fecha_nac" id="fecha_nac" required value="<?php echo $this->datos['fecha_nac'];?>">
				        </label>
				      </div>
				      <div class="small-12 medium-4 cell">
				        <label>Foto
